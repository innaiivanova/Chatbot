# Codecademy's rule based chatbot works with dorian_gray.txt and chunk_counters.py
# Inna I. Ivanova
...
# define new verb phrase chunk grammar here
new_chunk_grammar = """NP: {<.*>+}
                       }<VB.?>+{"""

# create verb phrase RegexpParser object here
new_chunk_parser = RegexpParser(new_chunk_grammar)


# create a list to hold noun phrase chunked sentences and a list to hold verb phrase chunked sentences here
np_chunked_text = list()
vp_chunked_text = list()
new_chunked_text = list()
...
for pos_tagged_sentence in pos_tagged_text:
  new_chunked_text.append(new_chunk_parser.parse(pos_tagged_sentence))
...
# store and print the most common VP-chunks here
most_common_new_chunks = np_chunk_counter(new_chunked_text)
print(most_common_new_chunks)
